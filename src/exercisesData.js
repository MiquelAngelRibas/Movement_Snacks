  ...
  pierna: [
    {
      ...
      phases: [
        ...
        { phase: 3, duration: 25, name: 'Zancadas Atrás (Lunges)', desc: 'Pasos alternos atrás flexionando la rodilla trasera a 90 grados.', muscles: 'Glúteos, Cuádriceps, Isquiotibiales', youtubeId: '-Q_2HR5OhEY' },
        ...
        { phase: 5, duration: 35, name: 'Respiración Profunda (Cooldown)', desc: 'Siéntate o quédate de pie. Inhala lento por la nariz expandiendo el abdomen y exhala suavemente por la boca.', muscles: 'Recuperación, Calma', youtubeId: '' }
      ]
    },
    {
      ...
      phases: [
        ...
        { phase: 2, duration: 25, name: 'Sentadillas (Squats)', desc: 'Mantén el pecho alto y desciende de manera lenta y controlada.', muscles: 'Cuádriceps, Glúteos', youtubeId: 'PyUP10dh8CE' },
        { phase: 3, duration: 25, name: 'Zancadas Atrás (Lunges)', desc: 'Mantén el core tenso mientras ejecutas las zancadas continuas.', muscles: 'Glúteos, Cuádriceps, Isquiotibiales', youtubeId: '-Q_2HR5OhEY' },
        { phase: 4, duration: 25, name: 'Elevación de Talones (Calf Raises)', desc: 'Eleva los talones controladamente apretando las pantorrillas arriba.', muscles: 'Pantorrillas, Tobillos', youtubeId: 'UV8gOrHmuKc' },
        { phase: 5, duration: 35, name: 'Respiración Profunda (Cooldown)', desc: 'Inhala profundamente llenando los pulmones y exhala despacio liberando toda la tensión del torso.', muscles: 'Recuperación, Calma', youtubeId: '' }
      ]
    },
    {
      ...
      phases: [
        ...
        { phase: 2, duration: 25, name: 'Sentadillas Isométricas (Squat Hold)', desc: 'Baja a posición de sentadilla profunda y mantén la posición libre.', muscles: 'Cuádriceps, Core, Hombros', youtubeId: 'OpiE9QGKfuo' },
        { phase: 3, duration: 25, name: 'Zancadas Atrás (Lunges)', desc: 'Realiza zancadas alternas controladas manteniendo el torso vertical.', muscles: 'Glúteos, Cuádriceps, Isquiotibiales', youtubeId: '-Q_2HR5OhEY' },
  ...
  empuje: [
    {
      ...
      phases: [
        ...
        { phase: 3, duration: 25, name: 'Flexiones en Suelo (Push-Ups)', desc: 'Apoya rodillas o pies. Baja el pecho cerca del suelo manteniendo el abdomen tenso.', muscles: 'Pectoral Mayor, Deltoides Anterior, Tríceps', youtubeId: 'v9LABVJzv8A' },
        { phase: 4, duration: 25, name: 'Flexiones Diamante (Diamond Push-Ups)', desc: 'Junta manos formando un diamante bajo el pecho para aislar los tríceps.', muscles: 'Tríceps, Pectoral, Core', youtubeId: '1Y8pTxdwf3M' },
    ...
    },
    {
      ...
      phases: [
        ...
        { phase: 2, duration: 25, name: 'Flexiones Inclinadas (Push-Ups)', desc: 'Apóyate sobre una mesa o escritorio firme. Haz flexiones de ritmo lento.', muscles: 'Pectoral Inferior, Tríceps, Deltoides', youtubeId: 'v9LABVJzv8A' },
        ...
        { phase: 4, duration: 25, name: 'Flexiones en Suelo (Push-Ups)', desc: 'Haz flexiones estándar en el suelo tratando de mantener un ritmo constante.', muscles: 'Pectoral Mayor, Deltoides Anterior, Tríceps', youtubeId: 'v9LABVJzv8A' },
    ...
    },
    {
      ...
      phases: [
        ...
        { phase: 2, duration: 25, name: 'Flexiones en Suelo (Push-Ups)', desc: 'Realiza flexiones estrictas controladas en el suelo (apoya rodillas si es necesario).', muscles: 'Pectoral Mayor, Deltoides Anterior, Tríceps', youtubeId: 'v9LABVJzv8A' },
        { phase: 3, duration: 25, name: 'Burpees Completos (Burpees)', desc: 'Combina flexión en el suelo, recogida de piernas y un salto vertical.', muscles: 'Full Body, Cardio, Pecho, Piernas', youtubeId: 'E-Oc0zjeqWo' },
        { phase: 4, duration: 25, name: 'Flexiones Diamante (Diamond Push-Ups)', desc: 'Junta manos bajo el pecho y haz flexiones diamante para fatigar tríceps.', muscles: 'Tríceps, Pectoral, Core', youtubeId: '1Y8pTxdwf3M' },
        { phase: 5, duration: 35, name: 'Respiración Profunda (Cooldown)', desc: 'Respira con control. Inhalaciones de 4 segundos y exhalaciones lentas para apaciguar el pulso.', muscles: 'Recuperación, Calma', youtubeId: '' }
      ]
    },
    {
  ...
  movilidad: [
    ...
    },
    {
      ...
      phases: [
        ...
        { phase: 3, duration: 25, name: 'Movilidad de Hombros (Chest Expansions)', desc: 'Abre el pecho and junta los omóplatos controladamente.', muscles: 'Dorsales, Omóplatos', youtubeId: 'El_Sj5hisSs' },
